...
def main():
    ...
    with st.sidebar:
        ...
        st.session_state.user_preferences['display_mode'] = st.session_state.display_mode_toggle
        show_fundamentals = (st.session_state.user_preferences['display_mode'] == "Hybrid (Technical + Fundamentals)")
