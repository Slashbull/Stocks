"""
Wave Detection Ultimate 3.0 - FINAL STABLE PRODUCTION VERSION
============================================================
Professional Stock Ranking System with Advanced Analytics
Combines the stability of V1 with the performance and features of V2.
All known UI bugs are addressed, filtering logic is robust, and performance is optimized.

Version: 3.1.1-FINAL-STABLE
Last Updated: August 2025
Status: PRODUCTION READY - MERGED & OPTIMIZED
"""
...
# ============================================
# ROBUST SESSION STATE MANAGER (V2-LITE)
# ============================================

class RobustSessionState:
    """Bulletproof session state management - prevents most KeyErrors without over-engineering"""
    ...
    STATE_DEFAULTS = {
        ...
        'last_refresh': None,
        'data_source': "sheet",
        'sheet_id': "1OEQ_qxL4lXbO9LlKWDGlDju2yQC1iYvOYeXF3mTQuJM", # V1 default for consistency
        'gid': "1823439984",
        'user_preferences': {
            'default_top_n': 50,
...
def load_and_process_data(source_type: str = "sheet", file_data=None, 
    ...
    try:
        ...
        # Use V2's optimized pattern detection
...
# ============================================
# PATTERN DETECTION ENGINE - FULLY OPTIMIZED (FROM V2)
# ============================================
...
# ============================================
# FILTER ENGINE - ROBUST AND INTERCONNECTED
# ============================================
...
class FilterEngine:
    ...
    def get_filter_options(df: pd.DataFrame, column: str, current_filters: Dict[str, Any]) -> List[str]:
        """Get available filter options with a more robust approach"""
        
        if df.empty or column not in df.columns:
            return []
        
        # Apply filters that are logically upstream
        temp_df = df.copy()
        
        # Start with the highest-level filters and work down
        ...
        try:
            values = sorted(values, key=lambda x: float(str(x).replace(',', '')) if str(x).replace(',', '').replace('.', '').replace('-', '').replace('x', '').isdigit() else x)
        except:
